...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Major.abbrev'
        db.alter_column(u'main_major', 'abbrev', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Major.title'
        db.alter_column(u'main_major', 'title', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Major.abbrev'
        db.alter_column(u'main_major', 'abbrev', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'Major.title'
        db.alter_column(u'main_major', 'title', self.gf('django.db.models.fields.CharField')(max_length=20))
