...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'main_brother', 'grad_year',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Brother.phone'
        db.delete_column(u'main_brother', 'phone')

        # Deleting field 'Brother.grad_year'
        db.delete_column(u'main_brother', 'grad_year')
