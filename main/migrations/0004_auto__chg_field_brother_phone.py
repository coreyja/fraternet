...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Brother.phone'
        db.alter_column(u'main_brother', 'phone', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'Brother.phone'
        db.alter_column(u'main_brother', 'phone', self.gf('django.db.models.fields.CharField')(max_length=9, null=True))
