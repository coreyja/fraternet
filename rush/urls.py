...
from .views.Rushie import RushieCreateView, RushieListView, RushieDetailView, CreateCommentView, RushieEditView, RushieDeleteView
...
urlpatterns = patterns('',
    ...
    url(r'^rushie/(?P<username>[-\w]+)/delete/$', RushieDeleteView.as_view(), name='delete_rushie'),
