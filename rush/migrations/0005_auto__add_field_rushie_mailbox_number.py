...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rushie.mailbox_number'
        db.add_column(u'rush_rushie', 'mailbox_number',
                      self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rushie.mailbox_number'
        db.delete_column(u'rush_rushie', 'mailbox_number')
