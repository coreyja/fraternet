...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClosedRush'
        db.create_table(u'rush_closedrush', (
            (u'event_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['events.Event'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'rush', ['ClosedRush'])


    def backwards(self, orm):
        # Deleting model 'ClosedRush'
        db.delete_table(u'rush_closedrush')
