...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'vote_poll', (
            ...
            ('rushee', self.gf('django.db.models.fields.related.ForeignKey')(related_name='polls', to=orm['rush.Rushie'])),
        ))
        ...
        db.create_table(u'vote_vote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('poll', self.gf('django.db.models.fields.related.ForeignKey')(related_name='votes', to=orm['vote.Poll'])),
            ('vote', self.gf('django.db.models.fields.CharField')(default='N', max_length=1)),
        ))
