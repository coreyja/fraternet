...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Vote.poll'
        db.alter_column(u'vote_vote', 'poll_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['vote.Poll']))

    def backwards(self, orm):

        # Changing field 'Vote.poll'
        db.alter_column(u'vote_vote', 'poll_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['vote.Poll']))
    ...
    models = {
        ...
        u'vote.vote': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'poll': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'votes'", 'null': 'True', 'to': u"orm['vote.Poll']"}),
